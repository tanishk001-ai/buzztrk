    ...
    <div className="min-h-svh">
      ...
      >
        <div className="absolute top-3 right-3">
          <ShareButton targetRef={cardRef} filename="buzztrk-personality.png" shareTitle="My BuzzTrk spending personality" shareText={`I'm ${result.label} on BuzzTrk ${result.emoji}`} />
        </div>
        <p className="text-base-950/70 text-sm font-semibold uppercase tracking-wide">Your spending personality</p>
        <div className="text-6xl my-4">{result.emoji}</div>
